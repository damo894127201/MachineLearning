...
!(function ($) {
    ...
    */
    ...
    var start_time = 1568304000, // toolbar 特殊样式起始时间戳new Date(2018,11,29).getTime()/1000
        ...
        logo_tpl = '<img src="//csdnimg.cn/cdn/content-toolbar/NationalDay.gif?v=20190924.1" class="csdn-logo-nationalday">',  // 正常样式
    ...
    var tpl = '\<div id="csdn-toolbar" style="background-color:#cb060f !important;" class="csdn-toolbar tb_disnone ' + skin + fixed + '">\
        <div class="container row center-block ">\
          ...
          <div class="pull-right login-wrap '+ loginMark + '">\
            <ul class="btns">\
              ...
              <img src="//csdnimg.cn/cdn/content-toolbar/csdn-write-nation.png">\
              <span>写博客</span></a>\
              <li class="gitChat upload msgBox" id="msgBox">\
              <a target="_blank" class="" href="//i.csdn.net/#/msg/index"><img src="https://csdnimg.cn/public/common/toolbar/images/messageIcon-nation.png" alt="" class="message"><div class="toolbar-circle" id="msg-circle"></div></a>\
    ...
    $(function () {
        ...
        var appHover = {
            showMore: function () {
                ...
                $(this).find('.link-title').css('color', '#ffe100')
                $dom.stop(true, true).fadeIn(200);
            },
            hideMore: function () {
                var $dom = $(this).find('.appControl');
