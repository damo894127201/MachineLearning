(function(window, document /*,undefined*/) {
  ...
  var positionConfig = {
    ...
    WAP9: { sceneId: 13169, itemSetId: 8281 },
    SEARCH_1: { sceneId: 13169, itemSetId: 8281 },
    T28: { sceneId: 11570, itemSetId: 7199 },
    T33: { sceneId: 11570, itemSetId: 7199 },
  ...
  function render4P(item, renderParentDom, pos) {
    ...
    if (
      ...
      itemDom.innerHTML =
        '<a href="' +
        item.url +
        '" target="_blank"><div class="content-box">'+
        '<img src="'+item.cover_url+ '" width=700 height=100/>'
        +'</div>'
        '</a>';
   ...
   * @param {位置} position
   */
  function renderAdShuangXingXian(renderParentDom, position) {
    if (position === 'WAP3') {
      renderParentDom.style.padding = '0';
      ...
      (function() {
        var scriptT3Dom = document.createElement('script');
        scriptT3Dom.src = '//www.nkscdn.com/smu0/o.js';
        scriptT3Dom.setAttribute('smua', 'd=m&s=b&u=u4052634&h=20:6');
        renderParentDom.appendChild(scriptT3Dom);
      })();
    } else if (position === 'WAP9') {
      renderParentDom.style.padding = '0';
      renderParentDom.style.border = 'none';
      (function() {
        var scriptT3Dom = document.createElement('script');
        scriptT3Dom.src = '//cache.api-zdj.com/code/100282.js';
        renderParentDom.appendChild(scriptT3Dom);
      })();
    } else if (position === 'SEARCH_1') {
      renderParentDom.style.padding = '0';
      renderParentDom.style.border = 'none';
      (function() {
        var scriptT3Dom = document.createElement('script');
  ...
  window.p4CSDNRender_T = function(renderDomId, pos) {
    ...
    if (renderDom && pos) {
      if (pos === 'WAP3' || pos === 'WAP9' || pos === 'SEARCH_1') {
        p4CSDNTBootstrap(renderCallBack, renderDom, pos);
        renderAdShuangXingXian(renderDom, pos);
      } else {
        p4CSDNTBootstrap(renderCallBack, renderDom, pos);
      }
    }
