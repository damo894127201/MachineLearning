...
(function() {
    ...
    checkDomain()
    right_public_footer+= right_public_footer_beian
    right_public_footer+= right_public_footer_bottom
    ...
    function checkDomain() {
        if(location.hostname.match('csdn.net') != null) {
            right_public_footer_beian = '<a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010502030143" target="_blank" class="ml14">京公网安备11010502030143</a></p>'
        } else if(location.hostname.match('iteye.com') != null) {
            right_public_footer_beian = '<a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010502030278" target="_blank">京公网安备11010502030278</a></p>'
        }
    }
