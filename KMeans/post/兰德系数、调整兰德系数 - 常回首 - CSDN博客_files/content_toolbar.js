...
document.write("<scr"+"ipt src='https://g.csdnimg.cn/asdf/23421/counter.js'></scr"+"ipt>");
var _gaq = [];
 ...
 * 二级域名 getSecondaryDomain
  ...
  //  festival customize
    var start_time = 1559836800, // toolbar 特殊样式起始时间戳new Date(2018,11,29).getTime()/1000
        end_time = 1560009600,  // toolbar 特殊样式结束时间戳
        ...
        // }
        if(now_time > start_time && now_time < end_time ){
          logo_tpl = '<img src="//csdnimg.cn/cdn/content-toolbar/csdn-duanwu.jpg">';
          logo_title = '端午节';
        }
          ...
          <div class="pull-right login-wrap '+loginMark+'">\
            ...
            <li class="toolbar-tracking csdn-tracking-statistics tracking-click" data-mod="popu_369"><a href="#" style="padding:0"></a></li>\
              ...
              <li class="userLogin">\
                ...
                <div><i class="pull_icon pull_icon2"></i><a href="https://i.csdn.net/#/uc/collection-list" target="_blank">我的收藏</a></div>\
