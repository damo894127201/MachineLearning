...
class DecisionTree:
    ...
    def _buildTree(self,X,Y,current_depth=0):
            ...
            for feature_index in range(n_features):
                ...
                for threshold in unique_values:
                    ...
                    if len(data1) > 0 and len(data2) > 0:
                        ...
                        label1 = [label for label in label1 ]
                        label2 = data2[:,n_features:]
                        label2 = [label for label in label2]
                        # 获取impurity
                        impurity = self.impurity_calculation(Y,label1,label2,self.lambd,self.gama)
        ...
        leaf_value = self.leaf_value_calculation(Y,self.lambd)
